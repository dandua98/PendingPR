...
(function (PullRequestHandler) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                _loop_1 = function (issue) {
                    isOpenIssue(context, issue).then(function (resp) { return __awaiter(_this, void 0, void 0, function () {
                        var payload;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    ...
                                    return [4 /*yield*/, context.github.issues.addLabels(payload)];
                                case 1:
                                    _a.sent();
                                    _a.label = 2;
    ...
    function onEditRequestHandler(context) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, onOpenRequestHandler(context)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                _loop_2 = function (issue) {
                    hasLabelPendingPR(context, issue).then(function (resp) { return __awaiter(_this, void 0, void 0, function () {
                        var payload;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    ...
                                    return [4 /*yield*/, context.github.issues.removeLabels(payload)];
                                case 1:
                                    _a.sent();
                                    _a.label = 2;
                                case 2: return [2 /*return*/];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, context.github.issues.get(payload).then(function (resp) {
                                if (resp.status === http_status_codes.OK) {
                                    for (var _i = 0, _a = resp.data.labels; _i < _a.length; _i++) {
                                        var label = _a[_i];
...
})(PullRequestHandler = exports.PullRequestHandler || (exports.PullRequestHandler = {}));
