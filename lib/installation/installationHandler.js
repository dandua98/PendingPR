...
(function(InstallationHandler) {
      ...
      return __generator(this, function(_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              isArchived(context, getOwner(repo.full_name), repo.name)
            ];
          case 1:
            archived = _a.sent();
            return [
                  ...
                  return __awaiter(_this, void 0, void 0, function() {
                    return __generator(this, function(_a) {
                      switch (_a.label) {
                        case 0:
                          if (
                            !(resp.status !== http_status_codes.OK && !archived)
                          )
                            return [3 /*break*/, 2];
                          return [
                            4 /*yield*/,
                            context.github.issues.createLabel(payload)
                          ];
                        case 1:
                          _a.sent();
                          _a.label = 2;
  ...
  (InstallationHandler =
    exports.InstallationHandler || (exports.InstallationHandler = {}))
);
